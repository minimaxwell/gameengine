...
int main(int argc, char** argv) {
    ...
    level->addSequence( 0 , new ge::SourceSequence( p->clone() , 100000 , 12 ) );
    level->addSequence( 1000000 , new ge::SourceSequence( p->clone() , 1000000 , 15 ) );
    level->addSequence( 500000 , new ge::SourceSequence( p2->clone() , 200000 , 12 ) );
    level->addSequence( 2000000 , new ge::SourceSequence( p3->clone() , 100000 , 3 ) );
    level->addSequence( 2000000 , new ge::SourceSequence( p4->clone() , 300000 , 5 ) );
    level->addSequence( 2500000 , new ge::SourceSequence( p5->clone() , 300000 , 20 ) );
    level->addSequence( 3000000 , new ge::SourceSequence( p1->clone() , 500000 , 2 ) );
    level->addSequence( 3000000 , new ge::SourceSequence( p7->clone() , 600000 , 7 ) );
    level->addSequence( 3000000 , new ge::SourceSequence( p8->clone() , 400000 , 6 ) );
